...
*/
		...
		new ObjectOutputStream(new FileOutputStream(new File("StudentList.txt"))).writeObject(new Student("Shreyans Jain","18BCS3465"));
...
*/
		System.out.println(((Student)new ObjectInputStream(new FileInputStream(new File("StudentList.txt"))).readObject()).toString());
	}
}